...
function genInlineTemplate (el) {
  ...
  if (ast.type === 1) {
    var inlineRenderFns = generate$1(ast, currentOptions);
  ...
  Vue.prototype._render = function () {
    ...
    try {
      ...
      if (config.errorHandler) {
        ...
        if (process.env.NODE_ENV !== 'production') {
          warn$2(("Error when rendering " + (formatComponentName(vm)) + ":"));
        }
        throw e
      }
...
function parse$$1 (template, options) {
  return parse$1(template, getOptions(options))
}
function optimize$$1 (ast, options) {
  return optimize$1(ast, getOptions(options))
}
function generate$$1 (ast, options) {
  return generate$1(ast, getOptions(options))
}

exports.compile = compile;
exports.parse = parse$$1;
exports.optimize = optimize$$1;
